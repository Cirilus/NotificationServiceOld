...
func (_m *Repository) CreateAccount(ctx context.Context, _a1 models.Account) error {
...
func (_m *Repository) DeleteAccount(ctx context.Context, id uuid.UUID) error {
...
func (_m *Repository) GetAccountById(ctx context.Context, id string) (*models.Account, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Repository) GetAllAccounts(ctx context.Context) ([]models.Account, error) {
	ret := _m.Called(ctx)
...
func (_m *Repository) UpdateAccount(ctx context.Context, id uuid.UUID, _a2 models.Account) (*models.Account, error) {
